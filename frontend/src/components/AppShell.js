    ...
    <div className="min-h-screen bg-background flex">
      ...
      <aside className="hidden md:flex w-[240px] shrink-0 flex-col border-r border-border bg-white">
        <div className="flex items-center gap-2 px-6 h-16 border-b border-border">
          <img src="https://static.prod-images.emergentagent.com/jobs/a5624b55-271e-475e-b7f2-289728dea1db/images/c2366cbc5b415553f0e7a15df85e794d75397480b11ddc13c97ae35d53d7c3be.png" alt="Ordia" className="h-7 w-7 rounded-md object-contain" />
      ...
      <div className="flex-1 flex flex-col min-w-0">
        <header className="md:hidden flex items-center justify-between h-14 px-4 border-b border-border bg-white">
          <div className="flex items-center gap-2">
            <img src="https://static.prod-images.emergentagent.com/jobs/a5624b55-271e-475e-b7f2-289728dea1db/images/c2366cbc5b415553f0e7a15df85e794d75397480b11ddc13c97ae35d53d7c3be.png" alt="Ordia" className="h-6 w-6 rounded object-contain" />
